...
//        public_url
        ...
        env.put("LIBRETIME_POSTGRESQL_USERNAME", "rfa" + station.getUuid().toString());
        env.put("LIBRETIME_POSTGRESQL_DBNAME", "rfa" + station.getUuid().toString());
        env.put("LIBRETIME_POSTGRESQL_PASSWORD", "rfa" + station.getUuid().toString());
        env.put("LIBRETIME_RABBITMQ_HOST", libretime_rabbitmq_host);
        env.put("LIBRETIME_RABBITMQ_PORT", libretime_rabbitmq_port);
        env.put("LIBRETIME_RABBITMQ_VHOST", "/" + "rfa" + station.getUuid().toString());
        env.put("LIBRETIME_RABBITMQ_USERNAME", "rfa" + station.getUuid().toString());
        env.put("LIBRETIME_RABBITMQ_PASSWORD", "rfa" + station.getUuid().toString());
